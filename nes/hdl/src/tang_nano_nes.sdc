...
//Created Time: 2024-12-23 15:32:21
create_clock -name input_clock -period 37.037 -waveform {0 18.518} [get_ports {clock}]
create_generated_clock -name softcpuclk -source [get_nets {hdmi_pixel_clock}] -master_clock hdmi_clock -divide_by 2 [get_nets {soft_cpu_clock}]
