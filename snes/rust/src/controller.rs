...
#[non_exhaustive]
#[enum_dispatch::enum_dispatch(SnesControllerTrait)]
#[derive(
...
impl Default for SnesController {
    fn default() -> Self {
        SnesController::DummyController(DummyController::default())
    }
}

impl SnesController {
    /// Converts this type into the SnesControllerType struct
    pub fn get_type(&self) -> SnesControllerType {
        match self {
            SnesController::StandardController(_) => SnesControllerType::StandardController,
            SnesController::DummyController(_) => SnesControllerType::None,
        }
    }
}
...
impl SnesControllerType {
    ...
    pub fn make_controller(&self) -> SnesController {
        match self {
            SnesControllerType::StandardController => {
                SnesController::StandardController(StandardController::default())
            }
            SnesControllerType::None => SnesController::DummyController(DummyController::default()),
        }
    }
}
...
pub struct DummyController {
    /// Required to make the SnesControllerTrait functional
...
impl SnesControllerTrait for DummyController {
...
impl SnesControllerTrait for StandardController {
    fn parallel_signal(&mut self, s: bool) {
        self.strobe = s;
        self.check_strobe();
    }
